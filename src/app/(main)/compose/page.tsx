    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-md mx-auto space-y-4">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">메시지 전송</h1>
                    ...
                    {selectedFriend && (
                      <div className="flex items-center gap-2">
                        <Avatar className="h-6 w-6">
                          <AvatarImage
                            src={selectedFriend.friend_profile.avatar_url || ""}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>최대 200자까지 입력할 수 있습니다</CardDescription>
            {errors.content && (
